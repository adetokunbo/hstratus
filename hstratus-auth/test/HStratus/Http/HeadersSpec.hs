...
import HStratus.Mock (Scenario (..), defaultScenario, withMockAppCapturing)
import Network.HStratus.Http (fetchTrustData, login, loginWith, mkApiWith, requestSmsCode, verifySmsCode)
...
spec :: Spec
spec = describe "Network.HStratus.Http request headers" $ do
